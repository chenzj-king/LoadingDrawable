package com.dreamliner.loadingdrawable.render.rotate;
...
import com.dreamliner.loadingdrawable.DensityUtil;
...
public class LevelLoadingRenderer extends LoadingRenderer {
    ...
    protected void computeRender(float renderProgress) {
        ...
        if (renderProgress <= START_TRIM_DURATION_OFFSET) {
            ...
            float level1Increment = DECELERATE_INTERPOLATOR.getInterpolation(levelSwipeDegreesProgress) - LINEAR_INTERPOLATOR
                    .getInterpolation(levelSwipeDegreesProgress);
            float level3Increment = ACCELERATE_INTERPOLATOR.getInterpolation(levelSwipeDegreesProgress) - LINEAR_INTERPOLATOR
                    .getInterpolation(levelSwipeDegreesProgress);
